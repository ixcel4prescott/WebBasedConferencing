	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			$(this).each( function() {
				...
				if( o.selectAll ) html += '<label class="multiselect selectAll"><input type="checkbox" class="selectAll" /> Select All</label>';
				$(select).find('OPTION').each( function() {
					if( $(this).val() != '' ) {
					    html += '<label class="multiselect"><input type="checkbox" name="' + $(select).attr('name') + '" value="' + $(this).val() + '"';
